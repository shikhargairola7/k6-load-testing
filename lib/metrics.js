...
// Tagged {reason} so handleSummary can print WHY token requests failed
// (connection_error / bad_status / empty_body / token_not_found).
export const tokenFailureReason = new Counter('token_failure_reason');
